    ...
    <div className="h-10 w-3/4 cursor-text md:w-1/2">
      {showInput && (
        <textarea
          ...
          className="disabled:animate-shimmer w-full resize-none rounded bg-transparent bg-gradient-to-tl from-[#0000ee] to-[#00eaff] bg-clip-text font-serif text-xl font-thin tracking-tight sm:text-4xl text-transparent focus:outline-none disabled:cursor-not-allowed"
          placeholder="..."
